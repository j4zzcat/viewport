...
var CachingFactory = /** @class */ (function () {
    function CachingFactory(ctor, keyGenerator) {
        if (keyGenerator === void 0) { keyGenerator = function () {
            var args = [];
    ...
    CachingFactory.prototype.getOrCreate = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
