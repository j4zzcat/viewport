...
exports.WidgetCommandLine = exports.PageAction = void 0;
...
var BusinessLogic = /** @class */ (function () {
    ...
    BusinessLogic.configureLogger = function (verbose) {
        console.log(verbose);
    };
    ;
...
var PageAction = /** @class */ (function (_super) {
    ...
    function PageAction() {
        var _this = _super.call(this, {
            actionName: 'page',
            summary: 'Define a viewport page',
        ...
        //     parameterLongName: '--grid',
        //     parameterShortName: '-g',
        //     description: 'Grid formated as RowsxColumns.'
        // });
    ...
    PageAction.prototype.onExecute = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                console.log(this._grid.value);
                return [2 /*return*/];
            });
        });
    };
...
var WidgetCommandLine = /** @class */ (function (_super) {
    ...
    function WidgetCommandLine() {
        var _this = _super.call(this, {
            ...
            toolDescription: 'View rtsp/rtsps/unifi video streams in a web browser'
        }) || this;
        _this.addAction(new PageAction());
