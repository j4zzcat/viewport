import { IHomebridgePluginUi, IHomebridgeUiToastHelper, PluginConfig, PluginFormSchema, PluginMetadata, PluginSchema, ServerEnvMetadata } from './ui.interface';
export declare class MockHomebridgePluginUi extends EventTarget implements IHomebridgePluginUi {
    ...
    hideSchemaForm(): void;
    endForm(): void;
    createForm(schema: any, data: any): any;
