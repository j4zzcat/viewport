...
var ProtectLiveFrame;
(function (ProtectLiveFrame) {
    ProtectLiveFrame[ProtectLiveFrame["KEYFRAME"] = 247] = "KEYFRAME";
    ProtectLiveFrame[ProtectLiveFrame["CODECINFORMATION"] = 248] = "CODECINFORMATION";
    ProtectLiveFrame[ProtectLiveFrame["BEGINSEGMENT"] = 249] = "BEGINSEGMENT";
    ProtectLiveFrame[ProtectLiveFrame["INITSEGMENT"] = 250] = "INITSEGMENT";
    ProtectLiveFrame[ProtectLiveFrame["MOOF"] = 251] = "MOOF";
    ProtectLiveFrame[ProtectLiveFrame["VIDEO"] = 252] = "VIDEO";
    ProtectLiveFrame[ProtectLiveFrame["AUDIO"] = 253] = "AUDIO";
    ProtectLiveFrame[ProtectLiveFrame["MDAT"] = 254] = "MDAT";
    ProtectLiveFrame[ProtectLiveFrame["ENDSEGMENT"] = 255] = "ENDSEGMENT";
})(ProtectLiveFrame || (ProtectLiveFrame = {}));
/**
...
export class ProtectLivestream extends EventEmitter {
     ...
     */
    async start(cameraId, channel, lens = 0, segmentLength = 100, requestId = cameraId + "-" + channel.toString()) {
    ...
    async launchLivestream(cameraId, channel, lens, segmentLength, requestId) {
        const logError = (message, ...parameters) => this.log.error(requestId + ": " + message, ...parameters);
        ...
        try {
            ...
            this.ws?.once("error", this.errorHandler = (error) => {
    ...
    processLivestream() {
        ...
        this.ws.on("message", this.segmentHandler = (packet) => {
            ...
            for (;;) {
                ...
                if (!Object.values(ProtectLiveFrame).includes(header[0])) {
...
//# sourceMappingURL=protect-api-livestream.js.map