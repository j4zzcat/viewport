...
export class ProtectSnapshot {
    ...
    async snapFromTimeshift(request) {
    ...
    async snapFromFfmpeg(ffmpegInputOptions, request, buffer) {
        ...
        ffmpegOptions.push("-f", "image2pipe", "-c:v", "mjpeg", "pipe:1");
        // Instantiate FFmpeg.
...
//# sourceMappingURL=protect-snapshot.js.map