...
export class ProtectCamera extends ProtectDevice {
    ...
    configureCameraDetails() {
        ...
        if (this.hints.ledStatus && statusLedService) {
            ...
            statusLedService.getCharacteristic(this.hap.Characteristic.CameraOperatingModeIndicator)?.onSet(async (value) => {
    ...
    configureCrop() {
        ...
        // Inform the user.
        this.log.info("Cropping the video stream to %sx%s% starting at %sx%s%.", this.hints.cropOptions.width, this.hints.cropOptions.height, this.hints.cropOptions.x, this.hints.cropOptions.y);
